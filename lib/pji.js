...
pg.connect(options.connection, (err, client, done) => {
  ...
  function combineDateWithTime(d, t) {
    ...
    //   t.getUTCMilliseconds()
    // );
    console.log(moment.utc(d + '' + t).format('YYYY-MM-DD HH:mm:ss'), 'combine')
    return moment.utc(d + '' + t).format('YYYY-MM-DD HH:mm:ss');
  ...
  function toUTC(d) {
    ...
    // console.log(new Date(d).toISOString(), 'new Date(d).toISOString()')
    // console.log(new Date(
    //   d.getUTCFullYear(),
    //   d.getUTCMonth(),
    //   d.getUTCDate(),
    ...
    // )
    //**.toISOString();
    console.log(moment.utc(d).format('YYYY-MM-DD HH:mm:ss'), 'toutc');
